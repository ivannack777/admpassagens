    ...
    <header id="header" class="header">
        ...
        <div class="header-menu">
                    ...
                    <div class="header-left">
                        ...
                        <div class="form-inline">
                            <form class="search-form">
                                <input class="form-elements mr-sm-2" type="text" placeholder="Search ..." aria-label="Search">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="<?= $this->siteUrl() ?>#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="<?= $this->siteUrl('images/nouser.png') ?>" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?= $this->siteUrl() ?>#"><i class="fa fa-user"></i> My Profile</a>

                            <a class="nav-link" href="<?= $this->siteUrl() ?>#"><i class="fa fa-user"></i> Notifications <span class="count">13</span></a>
            ...
            <?php else : ?>
                <div class="col-sm-12">
                    <div class="user-area dropdown float-right">
                        <a href="/usuarios/login/form">Entrar</a>
                    </div>
                </div>
