...
class Pedidos extends BaseController
{
    ...
    /**
     * Localiza e retorna status dos pedidos .
     *
     * @return string json
     */
    public function status(Request $request, Response $response)
    {
        ...
        $this->views->render($response, 'left.php', $dados);
        $this->views->render($response, 'right_top.php', $dados);
        $this->views->render($response, 'pedidos_status.php', $dados);
        return $this->views->render($response, 'footer.php', $dados);
    }
     ...
     * @return string json
     */
    public function statusSave(Request $request, Response $response, array $args)
    {
        $id = $args['id'] ?? null;
        ...
        $apiResult = $this->api->post('pedidos/status/salvar/'. $id, $requests);
    ...
    public function download(Request $request, Response $response)
    {
        ...
        $current_row = 3;
        $current_col = 1;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Código pedido');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Origem');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Destino');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Valor');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Status');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Data');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Nome');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'CPF');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'RG');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'Celular');
        $current_col++;
        $sheet->setCellValueByColumnAndRow($current_col, $current_row, 'E-mail');
        $current_col++;
        ...
        foreach ($pedidos->data as $pedido) {
            ...
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->codigo);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->origem_cidade . ' - ' . $pedido->origem_uf);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->destino_cidade . ' - ' . $pedido->destino_uf);
            $current_col++;

            $cellValor = $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->valor)->getCellByColumnAndRow($current_col, $current_row);;
            $current_col++;
            ...
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->status . ': ' . $pedido->status_descricao);
            $current_col++;
            $cellData = $sheet->setCellValueByColumnAndRow($current_col, $current_row, \PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel($data->format('Y-m-d')))->getCellByColumnAndRow($current_col, $current_row);
            $current_col++;
            ...
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->pessoas_nome);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->pessoas_cpf);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->pessoas_rg);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->pessoas_celular);
            $current_col++;
            $sheet->setCellValueByColumnAndRow($current_col, $current_row, $pedido->pessoas_email);
            $current_col++;
