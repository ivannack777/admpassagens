        ...
        jQuery.ajax({
            ...
            success: function(retorno) {
                ...
                if (retorno.status == true) {
                    jQuery("#label_descricao"+id).html( jQuery("#descricao").val() );
                    jQuery("#label_origem"+id).html( jQuery("#origem").val() );
                    jQuery("#label_destino"+id).html( jQuery("#destino").val() );
                    jQuery("#label_data_saida"+id).html( jQuery("#data_saida").val() );
                    jQuery("#label_data_chegada"+id).html( jQuery("#data_chegada").val() );
                    jQuery("#label_detalhes"+id).html( jQuery("#detalhes").val() );
                    jQuery("#label_veiculos_id"+id).html( jQuery("#veiculos_id :selected").text() );
