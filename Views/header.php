...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= $this->siteUrl('apple-icon.png?'. time() ) ?>">
    <link rel="shortcut icon" href="<?= $this->siteUrl('favicon.ico?'. time() ) ?>">

    <link rel="stylesheet" href="<?= $this->siteUrl('vendors/bootstrap/dist/css/bootstrap.min.css?'. time() ) ?>">
    ...
    <link rel="stylesheet" href="<?= $this->siteUrl('vendors/jqvmap/dist/jqvmap.min.css?'. time() ) ?>">

    <link rel="stylesheet" href="<?= $this->siteUrl('assets/css/style.css?'. time() ) ?>">
    ...
    <script src="<?= $this->siteUrl('assets/js/select2.full.min.js?'. time() ) ?>"></script>
    <script src="<?= $this->siteUrl('assets/js/jquery.mask.min.js?'. time() ) ?>"></script>
    <script src="<?= $this->siteUrl('assets/js/jquery-ui.min.js?'. time() ) ?>"></script>
